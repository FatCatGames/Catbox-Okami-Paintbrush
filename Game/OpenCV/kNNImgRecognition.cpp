...
///////////////////////////////////////////////////////////////////////////////////////////////
void ImgRecognition::GenerateDatakNN()
{
...
void ImgRecognition::GetSymbolkNN(BrushSymbol& anOutSymbol, ID3D11Texture2D* aTexture, int width, int height, const std::function<void(bool aSucceeded)>& aCallback)
{
	...
	Engine::GetInstance()->GetThreadPool()->QueueJob([&] { ReadImagekNN(mat,anOutSymbol, callback); });
}
